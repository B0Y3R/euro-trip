...
window.TRIP = {
  ...
  legs: [
    ...
    { date: "Sep 8", iso: "2026-09-08", from: "TLL", to: "HEL", fromName: "Tallinn", toName: "Helsinki", mode: "ferry", status: "todo",
      note: "Tallink Megastar 10:30→12:30, €38.90 pp — D-Terminal to West Terminal 2, then cross town to Olympia Terminal" },
    { date: "Sep 8", iso: "2026-09-08", from: "HEL", to: "STO", fromName: "Helsinki", toName: "Stockholm", mode: "ferry", status: "booked",
      flightNo: "SILJA SERENADE", operator: "Tallink Silja", depart: "16:45", arrive: "10:00", arriveNextDay: true, duration: "17h 15m",
      note: "Res 75300037 · code 5269 · sea-view cabin for 3 · Olympia Terminal (Olympiaranta 1) → Värtahamnen, Stockholm" },
  ...
  timeline: [
    ...
    { date: "Tue 9/8",  iso: "2026-09-08", sleep: "ferry",      text: "Morning ferry back to Helsinki → 16:45 Silja Serenade to Stockholm", city: "tallinn" },
  ...
  stays: [
    ...
    { id: "ferry",      nights: 1, fromIso: "2026-09-08", toIso: "2026-09-09", transit: true, label: "Silja Serenade — Helsinki → Stockholm", flag: "⛴" },
  ...
  cities: [
    // ===================================================== HELSINKI
    {
      ...
      blurb: "You land at 14:00, so this is half a day, not a full one — in the city by about 15:30. Löyly is the non-negotiable: waterfront sauna, plunge into the Baltic, drinks on the deck. Book a slot in advance or it gets squeezed out. You come back through on Tue 9/8 to catch the Stockholm cruise, which buys a few spare hours for anything you miss.",
      map: { stops: [
    ...
    // ===================================================== TALLINN
    {
      ...
      currency: "€ euro · €1 ≈ $1.14",
      blurb: "Two nights in the best-preserved medieval city in Europe — ferry in from Helsinki Sunday, saunas and craft beer in Kalamaja. The Stockholm cruise is BOOKED but it sails from Helsinki, not Tallinn, so Tuesday starts with the 2-hour shuttle back across the gulf. Book that morning sailing and treat Tuesday as a travel day.",
      days: [
        { iso: "2026-09-06", text: "Ferry in from Helsinki — Old Town, Toompea viewpoints on arrival" },
        { iso: "2026-09-07", text: "Full day — Kalamaja, saunas, Telliskivi" },
        { iso: "2026-09-08", text: "10:30 shuttle back to Helsinki (in at 12:30), then the 16:45 Silja Serenade to Stockholm" },
      ],
      map: { stops: [
      ...
      sections: [
        { title: "Tue 9/8 — getting to the cruise", icon: "⛴️", cards: [
          { kind: "ferry", name: "Take the 10:30 Megastar — €38.90 pp", blurb: "Sept 8 sailings out of Tallinn D-Terminal are 07:30, 10:30, 12:30 (slow boat, 3h30), 13:30 and 16:30. The 10:30 lands at 12:30 with four hours of slack; the 13:30 lands at 15:30 and leaves you 45 minutes to cross Helsinki before registration shuts. Don't be a hero.", tags: ["★ book this", "2h", "€38.90 pp"], url: "https://www.tallink.com/travelling/one-way/tallinn-helsinki-ferry" },
          { kind: "ferry", name: "You arrive at the WRONG terminal", blurb: "The shuttle docks at West Terminal 2 (Tyynenmerenkatu 14); the Serenade leaves from Olympia Terminal (Olympiaranta 1) in the South Harbour, about 3 km away. Tram via Kamppi or a ~10-minute taxi — budget half an hour and don't discover this at 16:00.", tags: ["★ gotcha", "3 km apart"], url: "https://www.portofhelsinki.fi/en/passengers/passenger-terminals/olympia-terminal/connections-olympia-terminal/" },
          { kind: "ferry", name: "Silja Serenade — booked, res 75300037", blurb: "Security code 5269, one A-Standard sea-view cabin for three, €219.70 paid. Check in free at the terminal self-service kiosk with those two numbers — the service desk charges €10 a ticket to do the same thing.", tags: ["BOOKED", "kiosk = free"], url: "https://www.tallink.com/good-to-know/ports-and-terminals" },
          { kind: "ferry", name: "Registration closes 30 min before, gangway 20", blurb: "Boarding opens around 15:30 for the 16:45 departure. Land in Helsinki by early afternoon and the gap is yours — Löyly, the Old Market Hall, or anything Saturday's half day cost you.", tags: ["16:45 sharp", "board from ~15:30"], url: "https://www.portofhelsinki.fi/en/passengers/passenger-terminals/olympia-terminal/" },
        ] },
        { title: "Stay", icon: "🏨", cards: [
    ...
    // ===================================================== STOCKHOLM
    {
      ...
      blurb: "The Serenade docks at Värtahamnen at 10:00 — about 4 km north-east of the centre, so bus 76 or a taxi in. Wednesday is a half day and Thursday runs until the evening flight out of Arlanda. Vasa at opening is the one thing not to cut.",
      map: { stops: [
